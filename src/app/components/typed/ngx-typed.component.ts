...
@Component({
  ...
  selector: 'ngx-typed',
  templateUrl: 'ngx-typed.component.html',
  styleUrls: ['ngx-typed.component.css']
})
export class NgxTypedComponent implements AfterViewInit {
  ...
  private typed: Typed;
  @ViewChild('wrapper', { static: true }) private content: any;
