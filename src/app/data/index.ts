...
export const content = {
  ...
  'projects': {
    ...
    'projects': [
      {
        'title': 'Barclays CBS Upload',
        'subtitle': '04/2019',
        'img': 'bg-fmb'
      },
      {
        'title': 'BancABC (BW) USSD Statements',
        'subtitle': '03/2019',
        'img': 'bg-bancabc'
      },
      {
        'title': 'RWIMS SNR',
        'subtitle': '06/2017 – 2018/10',
        'img': 'bg-rwims-snr'
      },
      {
        'title': 'ZIMGOATS App',
        'subtitle': '11/2017 – 02/2018',
        'img': 'bg-smart-development-works'
      },
      {
        'title': 'FEDS TOMI',
      ...
      {
        'title': 'RWIMS',
        'subtitle': '06/2015 – 08/2016',
        'img': 'bg-rwims'
      },
      {
        'title': 'Municipal GIS (Gweru)',
        'subtitle': '06/2016 – 08/2016',
        'img': 'bg-gis'
      },
      {
        'title': 'AciesTech Website',
        'subtitle': '2017',
        'img': 'bg-aciestech'
      },
      {
  ...
  'accomplishments': {
    ...
    'content': [
      ...
      {
        'title': '2016',
        'paragraph': 'Solely Developed a web application (GIS) used as a Audit tool by Zimbabwe Innovative Technologies Pvt Ltd (Gweru City Council - Water Audit).'
      },
      {
        'title': '2016',
        'paragraph': 'Presented my thesis on a City Engineering Services Reporting System at Survey Institute of Zimbabwe\'s 2016 Congerence & AGM in Victoria Falls (ZW). The presentation was based on a prototype I developed to demonstrate how Web GIS can be liveraged to improve service delivery in local authorities.'
      }
    ]
  },
  'experience': {
        ...
        'elements': [
          {
            ...
            'list': [
              'Upgrade existing systems to Sybrin Enterprise Studio',
  ...
  'contact': {
    'intro': 'Feel free to contact me for project cooperation or an employment opportunity. I will reply as soon as possible...',
    'input': ['NAME', 'EMAIL', 'MESSAGE'],
    'button': 'Send message'
  },
  'footer': {
    'content': 'All righs reserved'
  }
};
